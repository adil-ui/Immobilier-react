        ...
        <article className="col-xl-4 col-lg-5 col-md-6 col-sm-10 col-10 mb-4 mx-auto card_container" >
            <div className="card border-0">
                <div className='card_img position-relative '>
                    <NavLink to='/details'><img src="/assets/images/apartement-01.jpg" alt="user_image" class="img-fluid" /></NavLink>
                ...
                <div>
                    <div className="pt-4 pb-1 px-4">
                        ...
                        <NavLink to='/details'><h5 className="fw-semibold mt-3 mb-4">{elt.elt.title}</h5></NavLink>
